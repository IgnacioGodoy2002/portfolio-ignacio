...
export function CosmicButton(
  ...
  const baseClassName = cn(
    ...
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-neutral-950",
    className
  )
  ...
  const content = (
    <>
      ...
      <span
        ...
        <span
          className="absolute inset-[-200%] animate-cosmic-spin bg-[conic-gradient(from_0deg,#3b82f6,#60a5fa,#bfdbfe,#2563eb,#1d4ed8,#38bdf8,#3b82f6)] opacity-95" />
      </span>
      ...
      <span
        ...
        <span
          className="absolute inset-[-200%] animate-cosmic-spin-slow bg-[conic-gradient(from_180deg,#bfdbfe_0%,transparent_30%,#3b82f6_50%,transparent_70%,#1d4ed8_100%)]" />
      </span>
